(function ($) {
	...
	mainMenuNav.meanmenu({
		...
		meanMenuClose:
			'<span class="mean-menu-text"><i class="lnr lnr-text-align-left"></i>Menu</span> <span class="menu-close"></span>',
		meanMenuOpen:
			'<span class="mean-menu-text"><i class="lnr lnr-text-align-left"></i>Menu</span> <span class="menu-bar"></span>',
